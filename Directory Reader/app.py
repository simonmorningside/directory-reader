...
if os.name == 'nt':  # Windows
    pytesseract.pytesseract.tesseract_cmd = os.path.join(os.getcwd(), 'external_bins', 'tesseract', 'tesseract.exe')
else:  # Mac/Linux (optional for future)
...
def convert_pdf_to_images(pdf_path):
    poppler_path = os.path.join(os.getcwd(), "external_bins", "poppler")
    if not os.path.exists(poppler_path):
        raise FileNotFoundError("Poppler binaries not found. Please make sure 'external_bins/poppler' exists.")
